...
WebSocket transport is enabled by default, with polling still available as a fallback. Set `DISABLE_WEBSOCKETS="true"` only if you want polling-only realtime.
